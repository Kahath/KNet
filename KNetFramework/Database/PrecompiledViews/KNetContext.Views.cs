...
[assembly: DbMappingViewCacheTypeAttribute(
	typeof(KNetFramework.Database.Context.KNetContext),
	typeof(KNetFramework.Database.PrecompiledViews.ViewsForBaseEntitySetsadc8b5dd6313d53efa016b2747686049932a748e49bd83a541e3d415688f42e6))]

namespace KNetFramework.Database.PrecompiledViews
{
	using System;
	...
	internal sealed class ViewsForBaseEntitySetsadc8b5dd6313d53efa016b2747686049932a748e49bd83a541e3d415688f42e6 : DbMappingViewCache
	{
		/// <summary>
		...
		{
			get { return "adc8b5dd6313d53efa016b2747686049932a748e49bd83a541e3d415688f42e6"; }
		}
		...
		public override DbMappingView GetView(EntitySetBase extent)
		{
			...
			if (extentName == "KNetContext.CommandLevels")
			{
				return GetView3();
			}

			if (extentName == "KNetContext.CommandLogs")
			{
				return GetView4();
			}

			if (extentName == "KNetContext.Commands")
			{
				return GetView5();
			}
			...
			if (extentName == "KNetContext.Logs")
			{
				return GetView8();
			}

			if (extentName == "KNetContext.LogTypes")
			{
				return GetView9();
			}
			...
			if (extentName == "KNetContext.Opcodes")
			{
				return GetView12();
			}

			if (extentName == "KNetContext.OpcodeTypes")
			{
				return GetView13();
			}
			...
			if (extentName == "KNetContext.PacketLogs")
			{
				return GetView16();
			}

			if (extentName == "KNetContext.PacketLogTypes")
			{
				return GetView17();
			}
			...
			if (extentName == "KNetContext.Servers")
			{
				return GetView19();
			}
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM KNetContext.CommandLevels AS T
    ) AS T1");
		}
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM KNetContext.CommandLogs AS T
    ) AS T1");
		}
    ...
    SELECT VALUE -- Constructing CommandModel
        [CodeFirstDatabaseSchema.CommandModel](T1.CommandModel_ID, T1.CommandModel_Name, T1.CommandModel_Description, T1.CommandModel_CommandLevelID, T1.CommandModel_ParentID, T1.CommandModel_AssemblyName, T1.CommandModel_TypeName, T1.CommandModel_MethodName, T1.CommandModel_Active, T1.CommandModel_DateCreated, T1.CommandModel_DateModified, T1.CommandModel_DateDeactivated)
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM KNetContext.Commands AS T
    ) AS T1");
		}

		/// <summary>
		/// Gets the view for KNetContext.CommandLevels.
		/// </summary>
		/// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing CommandLevels
        [KNetFramework.Database.Context.CommandLevelModel](T1.CommandLevelModel_ID, T1.CommandLevelModel_Name, T1.CommandLevelModel_Active, T1.CommandLevelModel_DateCreated, T1.CommandLevelModel_DateModified, T1.CommandLevelModel_DateDeactivated)
    FROM (
        SELECT 
            T.ID AS CommandLevelModel_ID, 
            T.Name AS CommandLevelModel_Name, 
		...
		/// <summary>
		/// Gets the view for KNetContext.CommandLogs.
		/// </summary>
		/// <returns>The mapping view.</returns>
    ...
    FROM (
		...
		/// <summary>
		/// Gets the view for KNetContext.Commands.
		/// </summary>
		/// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing Commands
        [KNetFramework.Database.Context.CommandModel](T1.CommandModel_ID, T1.CommandModel_Name, T1.CommandModel_Description, T1.CommandModel_CommandLevelID, T1.CommandModel_ParentID, T1.CommandModel_AssemblyName, T1.CommandModel_TypeName, T1.CommandModel_MethodName, T1.CommandModel_Active, T1.CommandModel_DateCreated, T1.CommandModel_DateModified, T1.CommandModel_DateDeactivated)
    FROM (
        SELECT 
            T.ID AS CommandModel_ID, 
            T.Name AS CommandModel_Name, 
    ...
    SELECT VALUE -- Constructing LogModel
        [CodeFirstDatabaseSchema.LogModel](T1.LogModel_ID, T1.LogModel_Message, T1.LogModel_Description, T1.LogModel_LogTypeID, T1.LogModel_Active, T1.LogModel_DateCreated, T1.LogModel_DateModified, T1.LogModel_DateDeactivated)
    FROM (
        SELECT 
            T.ID AS LogModel_ID, 
            T.Message AS LogModel_Message, 
            T.Description AS LogModel_Description, 
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM KNetContext.LogTypes AS T
    ) AS T1");
		}

		/// <summary>
		/// Gets the view for KNetContext.Logs.
		/// </summary>
		/// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing Logs
        [KNetFramework.Database.Context.LogModel](T1.LogModel_ID, T1.LogModel_Message, T1.LogModel_Description, T1.LogModel_LogTypeID, T1.LogModel_Active, T1.LogModel_DateCreated, T1.LogModel_DateModified, T1.LogModel_DateDeactivated)
    FROM (
        SELECT 
            T.ID AS LogModel_ID, 
            T.Message AS LogModel_Message, 
		...
		/// <summary>
		/// Gets the view for KNetContext.LogTypes.
		/// </summary>
		/// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing LogTypes
        [KNetFramework.Database.Context.LogTypeModel](T1.LogTypeModel_ID, T1.LogTypeModel_Name, T1.LogTypeModel_Active, T1.LogTypeModel_DateCreated, T1.LogTypeModel_DateModified, T1.LogTypeModel_DateDeactivated)
    FROM (
        SELECT 
            T.ID AS LogTypeModel_ID, 
            T.Name AS LogTypeModel_Name, 
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM KNetContext.OpcodeTypes AS T
    ) AS T1");
		}

		/// <summary>
		/// Gets the view for KNetContext.Opcodes.
		/// </summary>
		/// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing Opcodes
        [KNetFramework.Database.Context.OpcodeModel](T1.OpcodeModel_ID, T1.OpcodeModel_Code, T1.OpcodeModel_TypeID, T1.OpcodeModel_Version, T1.OpcodeModel_Author, T1.OpcodeModel_AssemblyName, T1.OpcodeModel_TypeName, T1.OpcodeModel_MethodName, T1.OpcodeModel_Active, T1.OpcodeModel_DateCreated, T1.OpcodeModel_DateModified, T1.OpcodeModel_DateDeactivated)
    FROM (
        SELECT 
            T.ID AS OpcodeModel_ID, 
            T.Code AS OpcodeModel_Code, 
		...
		/// <summary>
		/// Gets the view for KNetContext.OpcodeTypes.
		/// </summary>
		/// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing OpcodeTypes
        [KNetFramework.Database.Context.OpcodeTypeModel](T1.OpcodeTypeModel_ID, T1.OpcodeTypeModel_Name, T1.OpcodeTypeModel_Active, T1.OpcodeTypeModel_DateCreated, T1.OpcodeTypeModel_DateModified, T1.OpcodeTypeModel_DateDeactivated)
    FROM (
        SELECT 
            T.ID AS OpcodeTypeModel_ID, 
            T.Name AS OpcodeTypeModel_Name, 
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM KNetContext.PacketLogs AS T
    ) AS T1");
		}
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM KNetContext.PacketLogTypes AS T
    ) AS T1");
		}

		/// <summary>
		/// Gets the view for KNetContext.PacketLogs.
		/// </summary>
		/// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing PacketLogs
        [KNetFramework.Database.Context.PacketLogModel](T1.PacketLogModel_ID, T1.PacketLogModel_IP, T1.PacketLogModel_ClientID, T1.PacketLogModel_Size, T1.PacketLogModel_PacketLogTypeID, T1.PacketLogModel_Opcode, T1.PacketLogModel_Message, T1.PacketLogModel_Active, T1.PacketLogModel_DateCreated, T1.PacketLogModel_DateModified, T1.PacketLogModel_DateDeactivated)
    FROM (
        SELECT 
            T.ID AS PacketLogModel_ID, 
            T.IP AS PacketLogModel_IP, 
		...
		/// <summary>
		/// Gets the view for KNetContext.PacketLogTypes.
		/// </summary>
		/// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing PacketLogTypes
        [KNetFramework.Database.Context.PacketLogTypeModel](T1.PacketLogTypeModel_ID, T1.PacketLogTypeModel_Name, T1.PacketLogTypeModel_Active, T1.PacketLogTypeModel_DateCreated, T1.PacketLogTypeModel_DateModified, T1.PacketLogTypeModel_DateDeactivated)
    FROM (
        SELECT 
            T.ID AS PacketLogTypeModel_ID, 
            T.Name AS PacketLogTypeModel_Name, 
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM KNetContext.Servers AS T
    ) AS T1");
		}

		/// <summary>
		/// Gets the view for KNetContext.Servers.
		/// </summary>
		/// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing Servers
        [KNetFramework.Database.Context.ServerModel](T1.ServerModel_ID, T1.ServerModel_IsSuccessful, T1.ServerModel_Active, T1.ServerModel_DateCreated, T1.ServerModel_DateModified, T1.ServerModel_DateDeactivated)
    FROM (
        SELECT 
            T.ID AS ServerModel_ID, 
            T.IsSuccessful AS ServerModel_IsSuccessful, 
