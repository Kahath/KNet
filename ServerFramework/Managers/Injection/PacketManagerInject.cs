...
namespace ServerFramework.Managers.Injection
{
	public sealed class PacketManagerInject : IPacketManager
	{
		...
		public void Init()
		{
			...
			Manager.LogMgr.Log(LogTypes.Normal, $"{PacketHandlersCount} packet handlers loaded");
		}
		...
		public void InvokeHandler(Packet packet)
		{
			...
			{
				Manager.LogMgr.Log(LogTypes.Warning, $"Opcode 0x{packet.Header.Opcode:X} doesn't have handler");
			}
		}
